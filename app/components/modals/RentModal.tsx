...
const RentModal = () => {
    ...
    let bodyContent = (
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grrid-cols-2 gap-3 max-h-[50vh] overflow-y-auto">
                {categories.map((item) => (
    ...
    return (
        <div>
            <Modal title="Airbnb your home!" isOpen={rentModal.isOpen} onClose={rentModal.onClose} onSubmit={handleSubmit(onSubmit)} actionLabel={actionLabel} secondaryAction={step === STEPS.CATEGORY ? undefined : onBack} secondaryActionLabel={secondaryActionLabel} body={bodyContent} />
        </div>
    )
}
